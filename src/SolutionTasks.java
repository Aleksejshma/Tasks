...
//                break;
        ...
        if (year <= 0) {
            ...
            System.out.println("Введенный год - еще не наступил, но точно будет высокосным. Количество дней в этом году составит - 366.");
        } else if (viscosYear == 0 && year < 2023) {
            System.out.println("Введенный год уже прошел и являлся высокосным. Количество дней в этом году составило - 366.");
        } else if (viscosYear != 0 && year < 2023) {
            System.out.println("Введенный год уже прошел и высокосным не являлся. Количество дней в этом году составило - 365.");
        } else if (viscosYear != 0 && year > 2023) {
            System.out.println("Введенный год - еще не наступил, но высокосным точно не будет. Количество дней в этом году составит - 365.");
        } else if (year == 2023) {
            System.out.println("Это текущий год и он высокосным не является. Количество дней в этом году составило - 365.");
        }
    }
}
